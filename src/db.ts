...
export async function initDatabase() {
  ...
  if (count === 0) {
    const defaultPermissions = [
      ...
      ['用户管理', 'user', 'menu', null],
      ['用户新增', 'user:add', 'button', 2],
      ['用户编辑', 'user:edit', 'button', 2],
      ['用户删除', 'user:delete', 'button', 2],
      ['项目管理', 'project', 'menu', null],
      ['项目新增', 'project:add', 'button', 6],
      ['项目编辑', 'project:edit', 'button', 6],
      ['项目删除', 'project:delete', 'button', 6],
      ['卡密管理', 'cardkey', 'menu', null],
      ['卡密新增', 'cardkey:add', 'button', 10],
      ['卡密编辑', 'cardkey:edit', 'button', 10],
      ['卡密删除', 'cardkey:delete', 'button', 10],
      ['模板管理', 'template', 'menu', null],
      ['模板新增', 'template:add', 'button', 14],
      ['模板删除', 'template:delete', 'button', 14],
      ['角色管理', 'role', 'menu', null],
    ];
